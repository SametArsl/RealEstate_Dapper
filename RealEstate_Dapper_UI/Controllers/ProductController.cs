...
namespace RealEstate_Dapper_UI.Controllers
{
    public class ProductController : Controller
    {
        ...
        {
            var client = _httpClientFactory.CreateClient();
            var responseMessage = await client.GetAsync("https://localhost:44380/api/Products/ChangeProductDealOfTheDayToFalse/" + id);
        ...
        {
            var client = _httpClientFactory.CreateClient();
            var responseMessage = await client.GetAsync("https://localhost:44380/api/Products/ChangeProductDealOfTheDayToTrue/" + id);
